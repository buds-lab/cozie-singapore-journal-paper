...
\begin{table}[htbp]
\centering
\caption{Space-type findings that reinforce prior intuition: the acoustic environment. Details are drawn from the fingerprint, lift, and residual analyses of Section~\ref{sec:res-fingerprint-association}.}
